...
//-----------> This class is used to configure OKTA client manually & Override Default Configuration.
...
public class OAuthClientConfiguration {
    ...
    ClientRegistration oktaClientRegistration(
            ...
            @Value("${spring.security.oauth2.client.registration.my-internal-client.client-id}") String client_id,
            @Value("${spring.security.oauth2.client.registration.my-internal-client.client-secret}") String client_secret,
            @Value("${spring.security.oauth2.client.registration.my-internal-client.scope}") String scope,
            @Value("${spring.security.oauth2.client.registration.my-internal-client.authorization-grant-type}") String authorizationGrantType
    ) {
